...
# Raad in data
load(paste(out.path, "gset_analysis/objects/edeger-biomart_genotype_up.Rdata", sep = ""))
...
load(paste(out.path, "gset_analysis/objects/edeger-biomart_genotype_down.Rdata", sep = ""))
...
# Save GO objects and Path objetcs as well as data fremes
save(list = c("path_df"), 
     file = paste(out.path, "gset_analysis/objects/edeger-GO-Pathway_genotype.Rdata", sep = ""))
...
#     file = paste(out.path, "gset_analysis/objects/edeger-biomart-summary_genotype.Rdata", sep = ""))
#write.table(biomart_summary_table, 
#            file = paste(out.path, "gset_analysis/objects/edeger-biomart-summary_genotype.txt", sep = ""),
#            sep = "\t")
